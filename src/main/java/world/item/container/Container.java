package main.java.world.item.container;
...
public class Container extends Item {
    ...
    /**
     * attempts to set the lock state of this container with the given item. The lockNumbers of the items are compared. If they match and the container is lockable, the container lock state will be set successfully. Otherwise not. If the state changed, the main.java.database is updated with the new lock state.
     *
