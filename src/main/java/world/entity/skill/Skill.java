...
public enum Skill implements TraitBestower {
    ...
    Skill(String savableName, int elevationLevel, int ipCost, String associatedStat, StatContainer requiredStats, VisibilityType visibilityType, Skill[] requiredSkills, Trait[] requiredTraits, Trait[] bestowedTraits) {
