...
public class RoomConnectionTable implements DatabaseManager.DatabaseTable {
    ...
    public RoomConnectionTable() {
        ...
        CONSTRAINTS.add(String.format(Locale.US, "FOREIGN KEY (%s) REFERENCES %s(%s)",
                                      STATE, RoomConnection.State.TABLE_NAME, EnumTable.ENUM_NAME));
        CONSTRAINTS.add(String.format(Locale.US, "FOREIGN KEY (%s) REFERENCES %s(%s)",
                                      DIRECTION, RoomConnection.Direction.TABLE_NAME, EnumTable.ENUM_NAME));
        CONSTRAINTS.add(String.format(Locale.US, "FOREIGN KEY (%s) REFERENCES %s(%s)",
                                      FAILURE_DIRECTION, RoomConnection.Direction.TABLE_NAME, EnumTable.ENUM_NAME));
    }
